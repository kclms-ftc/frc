...
/**
 * gammaDrivetrain.java — Mecanum Wheel Drivetrain
 *
 * HOW IT WORKS:
 * -------------
...
public class gammaDrivetrain {
    ...
    private final gammaHardwareMapConfig robot;
     ...
     */
    public gammaDrivetrain(gammaHardwareMapConfig robot) {
        this.robot = robot;
