...
public class gammaOdometry {
    ...
    public double getAngularVelocityDegPerSec() {
        // Before: return pinpoint.getVelocity().getHeading(AngleUnit.DEGREES);
        return pinpoint.getHeadingVelocity(AngleUnit.DEGREES.getUnnormalized()); //must be unnormalised angle because velocity can be greater than 360 deg/sec
    }
